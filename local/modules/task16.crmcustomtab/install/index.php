...
use task16\Crmcustomtab\Orm\BookTable;
use task16\Crmcustomtab\Orm\AuthorTable;
use task16\Crmcustomtab\Data\TestDataInstaller;

Loc::getMessage(__FILE__);

class task16_crmcustomtab extends CModule
{
    public $MODULE_ID = 'task16.crmcustomtab';
    ...
    public function __construct()
    {
        ...
        $this->MODULE_DESCRIPTION = Loc::getMessage('TASK16_CRMCUSTOMTAB_INSTALL_MODULE_DESCRIPTION');
        $this->MODULE_NAME = Loc::getMessage('TASK16_CRMCUSTOMTAB_INSTALL_MODULE_NAME');
        $this->PARTNER_NAME = Loc::getMessage('TASK16_CRMCUSTOMTAB_PARTNER_NAME');
        $this->PARTNER_URI = Loc::getMessage('TASK16_CRMCUSTOMTAB_PARTNER_URI');
    }
    ...
    public function DoInstall(): void
    {
        if ($this->isVersionD7()) {
            ...
            throw new SystemException(Loc::getMessage('TASK16_CRMCUSTOMTAB_INSTALL_ERROR_VERSION'));
        }
    }
    ...
    public function InstallEvents(): void
    {
        ...
        $eventManager->registerEventHandler(
            ...
            $this->MODULE_ID,
            '\\task16\\Crmcustomtab\\Crm\\Handlers',
            'updateTabs'
        );
    }
